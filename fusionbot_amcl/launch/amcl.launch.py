...
def generate_launch_description():
    ...
    pkg_path = get_package_share_directory('fusionbot_amcl')
    map_pkg_path = get_package_share_directory('fusionbot_slam')

    map_file_path = os.path.join(map_pkg_path, 'maps', 'maze.yaml')
