...
def generate_launch_description():
    ...
    fb_nav_pkg = get_package_share_directory('fusionbot_nav')
    fb_slam_pkg = get_package_share_directory('fusionbot_slam')
    my_launch_dir = os.path.join(fb_nav_pkg, 'launch')
